...
export const MAP_23_MB: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_up1', x: 47.9, y: 21.05, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_up2', x: 54.37, y: 61.76, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_down1', x: 37.66, y: 23.6, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_up3', x: 44.3, y: 21.47, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1' },
    { id: 'stairs_down2', x: 50.97, y: 23.6, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down3', x: 63.87, y: 74.04, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_up4', x: 60.76, y: 77.3, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1' },
    { id: 'stairs_down4', x: 49.7, y: 25.98, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2' },
    { id: 'stairs_down5', x: 62.31, y: 25.98, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2' },
    { id: 'stairs_down6', x: 59.71, y: 69.12, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2' }
  ],
  objectives: [
