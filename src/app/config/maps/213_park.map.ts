...
export const MAP_213_PARK: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'hard_objective1', x: 61.68, y: 41.15, title: 'Locate 2 Crystal Meth Laboratories', description: 'Find and report the multiple meth laboratories, that accounts suggest can be found in the residence. Only 2 reqiered', type: 'hard_objective', layerId: 'ground' },
    { id: 'hard_objective2', x: 57.1, y: 32.26, title: 'Locate 2 Crystal Meth Laboratories', description: 'Find and report the multiple meth laboratories, that accounts suggest can be found in the residence. Only 2 reqiered', type: 'hard_objective', layerId: 'ground' },
    { id: 'hard_objective3', x: 57.48, y: 29.5, title: 'Locate 2 Crystal Meth Laboratories', description: 'Find and report the multiple meth laboratories, that accounts suggest can be found in the residence. Only 2 reqiered', type: 'hard_objective', layerId: 'ground' },
    { id: 'hard_objective4', x: 62.98, y: 42.04, title: 'Locate 2 Crystal Meth Laboratories', description: 'Find and report the multiple meth laboratories, that accounts suggest can be found in the residence. Only 2 reqiered', type: 'hard_objective', layerId: 'floor1' },
    { id: 'hard_objective5', x: 56.18, y: 45.63, title: 'Locate 2 Crystal Meth Laboratories', description: 'Find and report the multiple meth laboratories, that accounts suggest can be found in the residence. Only 2 reqiered', type: 'hard_objective', layerId: 'floor1' },
