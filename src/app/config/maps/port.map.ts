...
export const MAP_PORT: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_up1', x: 55.5, y: 37.11, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_up2', x: 58.24, y: 29.05, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_up3', x: 51, y: 55.6, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1' },
    { id: 'stairs_down1', x: 48.76, y: 51.06, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down2', x: 51.55, y: 43.62, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down3', x: 51.57, y: 48.13, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down4', x: 50.75, y: 47.16, title: 'To Second Floor', type: 'stairs_down', layerId: 'floor2' },
    { id: 'stairs_up4', x: 58.24, y: 32.35, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' }
  ],
  objectives: [
