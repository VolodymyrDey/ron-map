...
export const MAP_COSTA_VINO: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_down1', x: 47.81, y: 4.77, title: 'To Undeground', type: 'stairs_down', layerId: 'ground' },
    { id: 'stairs_up1', x: 50.58, y: 94.4, title: 'To Ground Floor', type: 'stairs_up', layerId: 'underground' },
