...
export const MAP_155_PLAYA_VISTA_LANE: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_up1', x: 20.71, y: 44.06, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_up2', x: 39.54, y: 56.61, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_up3', x: 62.14, y: 19.49, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_up4', x: 33.07, y: 63.33, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1' },
    { id: 'stairs_up5', x: 53.7, y: 66.54, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1' },
    { id: 'stairs_up6', x: 61.39, y: 33.16, title: 'To Second Floor', type: 'stairs_up', layerId: 'floor1' },
    { id: 'stairs_down1', x: 71.05, y: 22.17, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down2', x: 46.81, y: 61.61, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down3', x: 28.82, y: 50.19, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_up7', x: 64.16, y: 63.41, title: 'To First Floor', type: 'stairs_up', layerId: 'ground' },
    { id: 'stairs_down4', x: 72.9, y: 66.69, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down5', x: 32.86, y: 64.6, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2' },
    { id: 'stairs_down6', x: 52.73, y: 65.42, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2' },
    { id: 'stairs_down7', x: 61.39, y: 32.78, title: 'To First Floor', type: 'stairs_down', layerId: 'floor2' }
  ],
  objectives: [
