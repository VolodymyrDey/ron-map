...
export const MAP_CHERRYESSA_FARM: GameMapConfig = {
  ...
  markers: [
    ...
    { id: 'stairs_down1', x: 42.18, y: 49.59, title: 'To Undeground', type: 'stairs_down', layerId: 'ground' },
    { id: 'stairs_up_down1', x: 44.7, y: 37.49, title: 'To First Floor / To Undeground', type: 'stairs_up_down', layerId: 'ground' },
    { id: 'stairs_down2', x: 38.87, y: 33.23, title: 'To Ground Floor', type: 'stairs_down', layerId: 'floor1' },
    { id: 'stairs_down3', x: 47.31, y: 15.38, title: 'To Church Undeground', type: 'stairs_down', layerId: 'ground' },
    { id: 'stairs_down4', x: 48.57, y: 4.1, title: 'To Church Undegraund', type: 'stairs_down', layerId: 'ground' },
    { id: 'stairs_up1', x: 50.71, y: 26.13, title: 'To Church Ground', type: 'stairs_up', layerId: 'underground' },
    { id: 'stairs_up2', x: 49.71, y: 37.34, title: 'To Ground Floor', type: 'stairs_up', layerId: 'underground' },
    { id: 'stairs_up3', x: 44.58, y: 71.77, title: 'To Ground Floor', type: 'stairs_up', layerId: 'underground' },
    { id: 'stairs_up4', x: 47.39, y: 59.75, title: 'To Ground Floor', type: 'stairs_up', layerId: 'underground' }
  ],
  objectives: [
